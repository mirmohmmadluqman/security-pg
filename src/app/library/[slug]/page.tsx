...
const CodeBlock = ({ slug, code, isDark }: { slug: string, code: string, isDark: boolean }) => {
    ...
    return (
        <div className={cn(
            "flex flex-col rounded-none overflow-hidden border border-primary/20 shadow-2xl h-[650px]",
...
export default function VulnerabilityDetailPage() {
    ...
    return (
        <div className="min-h-screen bg-background relative overflow-hidden flex flex-col">
            ...
            <header className="h-20 border-b border-primary/20 flex items-center justify-between px-8 relative z-50 glass sticky top-0 bg-background/80 backdrop-blur-md">
                ...
                <div className="flex items-center gap-4">
                    <div className="hidden md:flex items-center gap-2 px-3 py-1.5 rounded-none bg-primary/10 border border-primary/20 text-xs text-muted-foreground uppercase tracking-widest font-mono">
                ...
                <div className="space-y-8 pb-12">
                    <div>
                        <div className="flex items-center gap-2 mb-4">
                            <span className="px-3 py-1 rounded-none bg-primary/10 text-primary text-xs font-bold uppercase tracking-wider border border-primary/20">
                        ...
                        <div className="flex flex-wrap gap-3 mb-6">
                            <div className="flex items-center gap-2 px-3 py-1.5 rounded-none bg-primary/5 border border-primary/10 text-xs font-medium">
